  ...
  return (
    <section className="py-10 bg-neutral-800 shadow-inner sm:pt-16 lg:pt-24">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
          <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            <img
              ...
              alt="logo"
              className="logo bg-[#F2F2F2] border-stone-500 rounded-lg"
            />
            ...
            <ul className="flex items-center space-x-3 mt-9">
              <li>
                <a
                  href="#"
                  title=""
                  className="flex items-center justify-center text-[#F2F2F2] transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600"
                >
                  <svg
                    className="w-4 h-4"
        ...
        <p className="text-xs text-center text-[#F2F2F2] ">
